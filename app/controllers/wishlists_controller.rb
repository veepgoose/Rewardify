class WishlistsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @wishlist.save
        format.html { redirect_to wishlist_url(@wishlist), notice: "Wish successfully created." }
  ...
  def update
    respond_to do |format|
      if @wishlist.update(wishlist_params)
        format.html { redirect_to wishlist_url(@wishlist), notice: "Wish successfully updated." }
